...
contract Complaints {
   ...
   struct complaint{                        // The sturcture of the complaint array
    ...
    function make_ComplaintsByPassing(string memory message) public {       
        ...
        no_of_complaints++;
        complaints_by_number[no_of_complaints] = complaint (message,"none",false,now,0,msg.sender,address(0));
    }
      ...
      function make_JudgementByPassing(string memory message) public only_government_agency  {   
        ...
        complaints_by_number[no_of_complaints].been_judged = true;
        complaints_by_number[no_of_complaints].time_of_judgement = now;
        complaints_by_number[no_of_complaints].judge = message;
        complaints_by_number[no_of_complaints]._government_agency = msg.sender;
    }
